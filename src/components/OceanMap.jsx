      ...
      const popupHtml = `
        <div class="p-3 font-sans min-w-[200px]">
          ...
          <div class="text-[10px] text-slate-400 flex items-center justify-between">
            ...
            <span class="bg-amber-500/15 text-amber-450 border border-amber-500/30 px-1 py-0.2 rounded font-bold text-[8.5px] font-mono">Simulated live drift (representative data)</span>
          </div>
        </div>
      `;
